...
#define CLOUD_ABSORPTION 2.8
#define LIGHT_SAMPLES 1
#define CLOUD_CENTER_HEIGHT 25.0 
...
vec3 volumetricLight(vec3 pos, vec3 viewDir, LightningBolt light, float cloudDensity, sampler2D iChannel0) {
